    ...
    'components' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
                ...
                'tasks/page/<page:\d+>/translation/<translation:\d+>/clean/<clean:\d+>/cargo/<cargo:\d+>/neo/<neo:\d+>/flat/<flat:\d+>/repair/<repair:\d+>/beauty/<beauty:\d+>/photo/<photo:\d+>/isNoExecutor/<isNoExecutor:\d+>/isRemote/<isRemote:\d+>/interval/<interval:\d+>' => 'tasks/index',
